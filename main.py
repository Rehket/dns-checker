...
if __name__ == "__main__":
    ...
    if name_server_list is None:
        raise EnvironmentError(
            "No name servers provided! Set the NAME_SERVER_LIST environment variable to a bar(|) delimited string of name servers!"
        )
    ...
    if address_list is None:
        raise EnvironmentError(
            "No address list provided! Set the ADDRESS_LIST environment variable to a bar(|) delimited string of addresses!"
        )
